...
!(function (t, e) {
                ...
                ? (function (t, e, s) {
                      return function i(n) {
                          ...
                          for (let { target: r } = n; r && r !== this; r = r.parentNode)
                              for (let a = o.length; a--; ) if (o[a] === r) return (n.delegateTarget = r), i.oneOff && B.off(t, n.type, e, s), s.apply(r, [n]);
                          return null;
                      };
                  })(t, s, i)
                : (function (t, e) {
        ...
        _addEventListeners() {
            this._config.keyboard && B.on(this._element, "keydown.bs.carousel", (t) => this._keydown(t)),
                "hover" === this._config.pause &&
                    (B.on(this._element, "mouseenter.bs.carousel", (t) => this.pause(t)), B.on(this._element, "mouseleave.bs.carousel", (t) => this.cycle(t))),
    ...
    B.on(document, "click.bs.collapse.data-api", '[data-bs-toggle="collapse"]', function (t) {
        ...
        i.find(s).forEach((t) => {
            ...
            let i;
            s ? (null === s._parent && "string" == typeof e.parent && ((s._config.parent = e.parent), (s._parent = s._getParent())), (i = "toggle")) : (i = e),
